var StampedFn =
  ...
  (function (n, t) {
    ...
    function nu(i, u) {
      var f, e;
      u
        ? (s("Using included jQ"), (r = u), (n.jQueryStamped = r), s(r))
        : (s("Loaded jQ"), (n.jQueryStamped = r));
    ...
    function iu(t) {
      ...
      e &&
        Object.keys(e.customer || {}).length === 0 &&
        (e.customer = {
          customerId:
            i.data("customer-id") ||
            (n.__st && n.__st.cid) ||
            (n.meta && n.page && n.meta.page.customerId),
        });
    }
    function gi() {
      var t, u, f;
      ...
      let i = o.SECURE_ENDPOINT + "/v2/rewards/init?",
        c = n.StampedGlobalOptions.stockistUrl
          ? encodeURIComponent(n.StampedGlobalOptions.stockistUrl)
          : n.StampedGlobalOptions.sId;
      r.ajax({
        type: "GET",
        dataType: "json",
        ...
        success: function (n) {
          n.hasFeature || p
            ? (console.log("Enabling Loyalty 2.0..."),
              (l = !0),
              (i = `${o.SERVICE_HOST.svc_loyalty_widget}/launcher?`))
            : ((l = !1), console.log("Enabling Loyalty 1.0..."));
        },
        error: function () {
          l = !1;
        ...
        const t = {
          ...
          stockistUrl: n.StampedGlobalOptions.stockistUrl,
          debug: null,
          isTest: f,
    ...
    function lf() {
      ...
      u.length ||
        ...
        i.setAttribute("id", "stamped-rewards-init"),
        t.body.appendChild(i));
      let f = n.StampedGlobalOptions.stockistUrl
        ? encodeURIComponent(n.StampedGlobalOptions.stockistUrl)
        : n.StampedGlobalOptions.sId;
      r.ajax({
        type: "GET",
    ...
    function nr(t, i, u) {
      var h = t.search,
        e = t.customOptionTitle
          ? t.customOptionTitle + "||" + t.customOptionValue
          : "",
        s = t.topic,
        c = h || s || e,
        f = 1;
    ...
    function uu(t) {
      ...
      r.ajax({
        type: "POST",
        url:
          `${o.SERVICE_HOST.svc_loyalty_widget}/launcher/points?` + r.param(i),
        data: e.customer,
        dataType: "json",
        success: function (n) {
          setTimeout(function () {
            r(
              ...
              f
            ).html(n.points_current_with_name);
            r("#label-balance-points", f).html(n.points_current_with_name);
            let t = r("#stamped-rewards-widget");
            r(".stamped-rewards-widget-points", t).html(
              n.points_current_with_name
            );
          }, 100);
          t && t(n);
        },
    ...
    function eu(n) {
      var i, t, u;
      for (
        $wrapperCards.html(""), r("body", f).attr("data-view", n), i = 0;
        i < e.html.cards.length;
        i++
      )
        (t = e.html.cards[i]),
          t &&
            ...
            n == t.type &&
            ((u = r(t.html)),
            u.attr("data-key", t.key),
            $wrapperCards.append(u));
    }
    function kf() {
      ...
      setTimeout(function () {
        ...
        l
          ? (console.log("Loading new FA css..."),
            (c =
              "//s3-us-west-2.amazonaws.com/stamped.io/cdn/fontawesome/css/all-6.4.min.css"),
        ...
        t.append(
          "<style>" +
            kr +
            ' .stamped-rewards-window { font-family:"Open Sans", "Helvetica Neue", Helvetica, Arial, sans-serif; }</style>'
        );
        ki() && t.attr("data-mobile", !0);
        e.customer && e.customer.customerEmail
          ? t.attr("data-logged-in", !0)
          : t.attr("data-logged-in", !1);
    ...
    function gf() {
      function u() {
        let t = n.StampedGlobalOptions.stockistUrl
          ? encodeURIComponent(n.StampedGlobalOptions.stockistUrl)
          : n.StampedGlobalOptions.sId;
        return (
          r.ajax({
      ...
      r(f).on(
        "click",
        '[data-campaign-completed="false"] .stamped-reward-card-button-earn',
        function () {
          ...
          if (u()) {
            if (i === "celebrateBirthday") {
              ...
              u.show();
              let c = r(
                  ".stamped-rewards-birthday-input-holder select.DOBDay option:checked",
                  f
                ).val(),
                a = r(
                  ".stamped-rewards-birthday-input-holder select.DOBMonth option:checked",
                  f
                ).val(),
                v = r(
                  ".stamped-rewards-birthday-input-holder select.DOBYear option:checked",
                  f
                ).val();
              if (c && a && v) {
                let f = v + "-" + a + "-" + c;
                ...
                t.html(
                  '<span class="stamped-button-icon stamped-button-loading"></span>'
                );
                let y = n.StampedGlobalOptions.stockistUrl,
                  p = n.StampedGlobalOptions.sId,
                  w = n.StampedGlobalOptions.apiKey;
                r.ajax({
                  type: "POST",
                  url: `${o.SERVICE_HOST.svc_loyalty_widget}/customer/update/date-of-birth?stockistUrl=${y}&sId=${p}&apiKey=${w}`,
                  data: {
                  ...
                  success: function (n) {
                    t.html(
                      '<span class="stamped-button-icon stamped-button-completed"><i class="fa-solid fa-check"></i></span>'
                    );
                    t.attr("disabled", !0);
                    u.hide();
      ...
      r(f).on(
        "click",
        ".stamped-reward-referral-platforms button",
        function () {
      ...
      r(f).on("click", ".stamped-rewards-header-menu span", function () {
        ...
        n != t &&
          ($wrapperCards.attr("data-target", n),
          eu(n),
          r(".stamped-rewards-content-container", f).scrollTop(0),
          r(".stamped-rewards-header-menu .active", f).removeClass("active"),
          r(this, f).addClass("active"));
      });
    ...
    function ou(n) {
      n == "reviews" &&
        r(
          '.stamped-rewards-header-menu span[data-target="reviews"]',
          f
        ).trigger("click");
    }
    function y(t, i, u, s = null) {
      ...
      if (
        ...
        r(".stamped-rewards-content-container", f).scrollTop(0),
        r(".stamped-rewards-header-nav", f).attr(
          "onclick",
          "StampedFn.loadLauncherView('main');"
        ),
        ...
        if (t == "main")
          ht.removeClass("stamped-rewards-nav-small"),
            ...
            r(
              ".stamped-rewards-header-main, .stamped-rewards-header-menu",
              f
            ).fadeIn(),
          ...
          if (((c = !1), u && u.reload == !0)) c = !1;
            ...
            for (v = 0; v < e.html.views.length; v++)
              (a = e.html.views[v]),
                a.key == t &&
                  (a.title && (h = a.title), (c = !0), tr(a.html), ir(t, h, u));
          if (!c) {
            tr();
            ir(t, h, u);
            w = null;
            ...
            l &&
              (b = `${o.SERVICE_HOST.svc_loyalty_widget}/templates/cardview`);
            const i = {
              apiKey: n.StampedGlobalOptions.apiKey,
              sId: n.StampedGlobalOptions.sId,
              stockistUrl: n.StampedGlobalOptions.stockistUrl,
    ...
    function tr(n, t, i) {
      if (n) {
        ...
        $wrapperViews.html(""),
          r(".stamped-view-loader", $wrapperViews).length ||
            $wrapperViews.append(r('<div class="stamped-view-loader"></div>')),
    ...
    function ir(n, t, i) {
      ...
      if (
        (n == "view-coupon" &&
          (r(".stamped-reward-coupon-code", $wrapperViews).text(i.couponCode),
          r(".stamped-reward-card-title", $wrapperViews).html(i.title),
          ie("view-your-rewards", !0)),
        n == "view-earnings" &&
          e &&
          e.customer &&
          ...
          u.length &&
            ((s = e.customer.dateBirthday),
            s
              ? u.attr("data-birthday", "true")
              : (u.attr("data-birthday", "false"),
                u.prepend(r(".stamped-rewards-birthday-input-holder", f))))),
        n == "view-referrals-claim",
        n == "view-redeem-variable" &&
          ((h = ".range-slider__range"),
          ($selectorInput = r(h, $wrapperViews)),
        ...
        r(".stamped-rewards-content-action-button ", $wrapperViews).on(
          "click",
          function () {
            t(this);
          }
    ...
    function rr(t, i, u = null, f = null) {
      ...
      let c =
          e.campaigns.earnings.filter((n) => n.id === t)[0] ||
          e.campaigns.tierEarnings.filter((n) => n.id === t)[0],
        s = "";
      switch (i) {
        case "facebookLike":
      ...
      i == "AccountBirthday"
        ...
        : (i == "SocialFollowInstagram" ||
          ...
          i == "SocialFollowInstagram"
            ...
            : i == "SocialFollowFacebook"
            ? n.open(
                "https://www.facebook.com/plugins/page.php?href=" + r.facebook,
                "_blank",
                "location=yes,height=250,width=340,top=50,left=50,scrollbars=yes,status=yes"
              )
            : i == "SocialShareFacebook"
            ? n.open(
                "https://www.facebook.com/sharer/sharer.php?u=" + r.shop,
                "_blank",
                "location=yes,height=500,width=500,top=50,left=50,scrollbars=yes,status=yes"
              )
            : i == "SocialFollowTwitter"
            ? ((u = n.open(r.twitter, "_blank")), u.focus())
            : i == "SocialShareTwitter"
            ? n.open(
                "https://twitter.com/intent/tweet?url=" + r.shop,
                "_blank",
                "location=yes,height=500,width=500,top=50,left=50,scrollbars=yes,status=yes"
              )
            : i == "SocialYouTube"
    ...
    function fr(t, i, u = null, f = null, s = null, c = null) {
      ...
      n.StampedGlobalOptions.sId = e.shopId;
      let v =
          e.campaigns.spendings.filter((n) => n.id === t)[0] ||
          e.campaigns.tierSpendings.filter((n) => n.id === t)[0],
        l = "";
      switch (i) {
        case "freeShipping":
          l = "redeem/shipping";
        ...
        success: function (n) {
          ...
          h("stamped:rewards:redeemed", {
            detail: {
              ...
              code: n.code,
              title: n.title,
              rewardCampaignCoupon: { couponCode: n.code },
            },
          });
        },
        error: function () {
    ...
    function ci(n) {
      ...
      n == "active" &&
        r(".stamped-rewards-coupons-view", f).attr("data-applied", "true");
      c(t, n);
    }
    function ue() {
      var n = r(
          ".stamped-reward-referral-wrapper .stamped-reward-copy-icon",
          f
        ),
    ...
    function fe(n) {
      ...
      if (
        (ci("loading"),
        (u = o.is_rewards_code_copy || a.indexOf("Copy") > -1 || v == "copy"),
        h("stamped:rewards:coupon:applied", { detail: t }),
        u == !0)
      )
        (s = t), dr(s), ci("active");
      else {
        ...
        u =
          e.shopId === 67527
            ? `${i.shop}/discount/${t}?redirect=/checkout`
            : i.shop + "/checkout?discount=" + t;
        c = "GET";
        l = {};
        o.rewards_apply_discount_url_format &&
          (u = rewards_apply_discount_url_format.replace("{0}", t));
        (n && n.skip) ||
          r.ajax({
            type: c,
            url: u,
      ...
      if (i) {
        ...
        l.map((n) => {
          r.ajax({
            type: "POST",
            url: y,
            data: { to: n, from: e.customer.customerEmail, customMessage: h },
          });
        });
        t.html("Invite sent!");
        setTimeout(function () {
    ...
    function oe() {
      ...
      if (i && s) {
        ...
        r.ajax({
          ...
          error: function (n) {
            let t = n.responseJSON
              ? n.responseJSON.message
              : n.responseText
              ? JSON.parse(n.responseText).message
              : "You are not eligible for the reward.";
    ...
    function he(n) {
      var t = e.links;
      n == "login"
        ? (top.location.href = t.login)
        : n == "signup" && (top.location.href = t.signup);
    }
    function c(n, t, i, r, u) {
      if (t == "loading") {
        ...
        i ||
          n.html(
            '<span class="stamped-button-icon stamped-button-completed"><i class="far fa-check"></i></span>'
          ),
          setTimeout(function () {
    ...
    function lu() {
      ...
      f == "slider"
        ? ((et = r(".stamped-reviews", u)),
          ...
          e
            ? (et.slick("slickAdd", r(".stamped-reviews > .stamped-review")),
              (l = r('.stamped-reviews [class*="stamped-review"]', u).length),
              l <= 0
                ? r("button.slick-arrow").hide()
                : r("button.slick-arrow").show())
            : yi("//cdn.stamped.io/cdn/js/slick.min.js", function () {
                et.slick(o.slick_options);
                et.on("afterChange", function (n, t, i) {
                  var f = r(".slick-next.slick-arrow").hasClass(
                      "slick-disabled"
                    ),
                    u;
                  f &&
                    ((_lastSlide = i),
                    (u = r(".stamped-pagination .next a")),
                    u.length && u.click());
                });
              }))
        : f == "masonry" &&
          ...
          n.macyInstanceConfig &&
            (n.macyInstanceConfig.breakAt &&
              (t.breakAt = n.macyInstanceConfig.breakAt),
            n.macyInstanceConfig.columns &&
              (t.columns = n.macyInstanceConfig.columns)),
      ...
      r(".stamped-sort-select").length &&
        ((i =
          u.attr("data-sort") ||
          r(".stamped-container", u).attr("data-widget-sort")),
        i &&
          ((c = r('.stamped-sort-select option[value="' + i + '"]')),
          c.css("display") &&
            c.css("display") !== "none" &&
            r(".stamped-sort-select").val(i)));
    }
    function au(n) {
      (u && u.length && !n) || (u = r(v));
      dt();
    ...
    function wu() {
      ...
      if (
        (t.points &&
          ((i = t.points.points),
          r("[id=stamped-rewards-points-placeholder]").attr(
            "onclick",
            "StampedFn.toggleRewardsModal();"
          ),
          r("[id=stamped-rewards-points-placeholder]").html(
            t.points.points_current_with_name
          ),
          r(
            '[id=stamped-rewards-points-placeholder][data-type="points-only"]'
          ).html(i),
          t.customer &&
            r("[id=stamped-rewards-viptier-placeholder]").html(
              t.customer.vipTierTitle
            ),
          (u = r(
            '[id=stamped-rewards-points-placeholder][data-type="points-price"]'
          )),
          u.length &&
            i >= 0 &&
            ((s = u.attr("data-ratio")),
            (c = u.attr("data-symbol")),
            s &&
              ((a = parseInt(s)),
              a && ((v = i > 0 ? (i / s).toFixed(2) : 0), u.html(c + v))))),
        t.customer &&
          r("[id=stamped-rewards-referral-placeholder]").html(
            t.customer.urlReferral
          ),
    ...
    function bu() {
      var n =
          r(u).attr("data-limit-words") ||
          r(".stamped-container", u).attr("data-widget-limit-words"),
              ...
              (t || i
                ...
                : ((o = f.split(" ")),
                  o.length > n &&
                    ...
                    r(u).html(txtTrimmed),
                    r(u).append(
                      '<a class="stamped-review-read-more" style="margin-left:10px; cursor:pointer;">read more</span>'
                    ),
                    r(u).append(
                      '<span class="original-review" style="display:none !important;">' +
                        f +
                        "</span>"
                    )))));
        });
      r(
        ".stamped-review-reply .stamped-review-reply-body, .stamped-review-reply .stamped-review-content-body"
      ).each(function () {
    ...
    function ku() {
      ...
      if (f) {
        for (
          r(".stamped-reviews-filter-label").show(),
            r(".stamped-summary-keywords").show(),
            r(u).removeAttr("data-keywords"),
            r(".stamped-summary-keywords-list", u).html(""),
            n = "",
            t = f.split(","),
            i = 0;
          i < t.length;
    ...
    function ce() {
      r(t).on(
        ...
        function (n) {
          if (a(n) === !0) {
            ...
            t.hasClass("stamped-mobile-visible")
              ? (t.slideUp(), t.removeClass("stamped-mobile-visible"))
        ...
        function (n) {
          if (a(n) === !0) {
            ...
            t.hasClass("selected")
              ...
              : (r(".stamped-summary-keywords-list li").removeClass("selected"),
                t.addClass("selected"),
                r(u).attr("data-keyword", t.text().trim()));
      ...
      r(t).on("change keyup", ".stamped-reviews-search-input", function (n) {
        var t = r(this).val();
        t
          ? (r(".stamped-reviews-search-clear").show(),
      ...
      r(t).on("change keyup", ".stamped-questions-search-input", function (n) {
        var t = r(this).val();
        t
          ? (r(".stamped-questions-search-clear").show(),
            r(".stamped-questions", u).attr("data-filtered", "true"))
          : (r(".stamped-questions-search-clear").hide(),
            r(".stamped-questions", u).removeAttr("data-filtered"));
        n.keyCode == 13 &&
          ((t = r(this).val()),
          t &&
            (r(u).attr("data-search-qna", t.trim()),
            r(".stamped-summary-actions-clear").show(),
            ui()));
      });
      r(t).on(
        "click keypress",
        ".stamped-questions-search-button",
        function () {
          if (a(event) === !0) {
            var n = r(".stamped-questions-questions-input").val();
            n &&
              (r(u).attr("data-search-qna", n.trim()),
              r(".stamped-summary-actions-clear").show(),
              ui());
          }
        }
      ...
      r(t).on(
        "click keypress",
        ".stamped-questions-search-clear",
        function (n) {
          a(n) === !0 &&
            (r(".stamped-questions-search-clear").hide(),
            r(".stamped-questions-search-input").val(""),
            r(u).removeAttr("data-search-qna"),
            ui());
        }
      );
    }
    function du() {
      r(t).on("click keypress", ".stamped-review-read-more", function (t) {
        if (a(t) === !0) {
          r(this)
            .closest(".stamped-review-content-body")
            .find(".stamped-review-read-more")
            .hide();
          var i = r(this)
            .closest(".stamped-review-content-body")
    ...
    function ae() {
      r(t).on(
        "click keypress",
        ".stamped-summary-ratings .summary-rating",
        function (n) {
          if (a(n) === !0) {
            ...
            i &&
              (u
                ? (ot(1), r(".stamped-summary-ratings").removeClass("selected"))
                : (t.addClass("selected"),
                  r(this).addClass("selected"),
                  r(".stamped-summary-ratings").addClass("selected"),
                  ot(1, i)));
          }
        }
      );
    ...
    function ve() {
      r(t).on(
        "mouseover mouseout",
        ".stamped-form-review-rating a.fa",
        function (n) {
          var i, t, u;
          i = n.currentTarget;
          ...
          for (o = r.byteLength, i = 2; i < o; )
            if (((e = r.getUint16(i, !1)), (i += 2), e == 65505)) {
              ...
              for (
                ...
                if (r.getUint16(i + f * 12, u) == 274)
                  return t(r.getUint16(i + f * 12 + 8, u));
      ...
      function o(n, i, r) {
        ...
        u.onload = function () {
          var f = u.width,
            ...
            n = o.getContext("2d");
          4 < i && i < 9
            ? ((o.width = e), (o.height = f))
            : ((o.width = f), (o.height = e));
          switch (i) {
            case 2:
          ...
          for (var i, f, s, o = n.target.files, e = 0; e < o.length; e++) {
            ...
            if ((tt++, i.type.match("image"))) c(i, tt);
              ...
              if (((s = i.size / 1048576), s > 50)) {
                ...
                alert(
                  "Sorry, you cannot add this video to your review. Up to 50mb is allowed."
                );
                return;
              }
              f.onload = function () {
                ...
                n.addEventListener("loadeddata", function () {
                  e()
                    ...
                    : r(".stamped-file-holder").append(h);
                  ft.push(i);
                });
                e = function () {
            ...
            i &&
              (/^image\//i.test(i.type) || /^video\//i.test(i.type)
                ? console.log("is image, begin upload")
                : (h("stamped:photo:invalid"),
    ...
    function be(n, t, i) {
      ...
      if (vr("stamped-user-reviews") != null) {
        for (
          r = JSON.parse(vr("stamped-user-reviews")), f = !1, u = 0;
          u < r.length;
          u++
        )
          if (r[u].pid == n) {
    ...
    function dt(t, i, f, e) {
      ...
      if (u.length && !wi) {
        ...
        var c = u.attr("data-product-id"),
          ...
          y =
            u.attr("data-load-type") ||
            r(".stamped-container", u).attr("data-widget-load-type"),
        ...
        i ||
          (i =
            ...
            r(".stamped-container", u).attr("data-widget-sort"));
        y === "continue" && (e = !0);
        r("#stamped-main-widget-placeholder").length &&
          r("#stamped-main-widget-placeholder").append(u);
        wi = !0;
        t && !e && b(".stamped-reviews");
        u.addClass("stamped-main-widget-loading");
        g = r("<span>Loading more...</span>").prependTo(
          r("#stamped-reviews-tab")
        );
        k = r.param(
          ni({
            productId: c,
        ...
        d = {
          ...
          success: function (n) {
            ...
            i &&
              ...
              r('.stamped-sort-select option[value="' + i + '"]', u).css(
                "display"
              ) !== "none" &&
              (r(".stamped-sort-select", u).val(i),
              r(".stamped-container", u).attr("data-widget-sort", i),
              r(u).attr("data-sort", i));
            r(".new-review-form").hide();
            r(".new-question-form").hide();
            h("stamped:reviews:loaded");
            r(".stamped-summary-actions-newreview").attr(
              "aria-controls",
              "new-review-form_" + (c != null ? c : "")
            );
            ss();
          },
          error: function () {},
    ...
    function or(t, i) {
      ...
      if (((u = r(v)), u.length)) {
        ...
        if (
          (i ||
            (i =
              u.attr("data-sort-qna") ||
              r(".stamped-container", u).attr("data-widget-sort-qna")),
          (c = u.data("linkify") || !1),
          !f)
        )
          return;
        ...
        r.ajax({
          ...
          success: function (n) {
            ...
            n.a == !0 &&
              ...
              ke(a),
              (f = r(
                '<div id="stamped-questions-tab" class="stamped-questions" role="tabpanel" aria-labelledby="tab-questions" tabindex="-1">'
              )),
              r(".stamped-questions").html(""),
              f.append(l),
              s &&
                ((y = r(".stamped-review #stamped-review-avatar", f)),
                (p = r('<img src="' + s + '" width="100">')),
                y.html(p)),
              (u = r(".stamped-questions-placeholder")),
              u.length
                ? (r(".stamped-questions", u).html(""),
                  r(".stamped-questions", u).replaceWith(f),
                  r(".stamped-questions", u).length ||
                    (r(".stamped-questions").appendTo(u),
                    r(".stamped-questions").replaceWith(f)),
              ...
              de(o, t || 1, e),
              u.length
                ? t > 1 && b(".stamped-questions-placeholder")
                : t > 1 && b(v),
              i ||
                r(".stamped-questions-filter .stamped-sort-select").val(
                  "recent"
                ),
              c &&
    ...
    function ke(n) {
      if (
        r(".stamped-questions").length &&
        !r(".question-form-wrapper").length
      ) {
    ...
    function de(n, t, i) {
      ...
      if (h != 1) {
        ...
        for (
          n >= 8 &&
            ((a = t - 2),
            a >= 1 && (t - 2 != 1 && u.push(t - 2), u.push(t - 1)),
            t != 1 && u.push(t),
            (s = t + 2),
            s <= n && (u.push(t + 1), s != n && u.push(t + 2))),
            t == 1 || t == 1
              ? r("#stamped-pagination-prev", e).hide()
              : r("#stamped-pagination-prev", e).show(),
            n == t || n == 1
              ? r("#stamped-pagination-next", e).hide()
              : r("#stamped-pagination-next", e).show(),
            n != t && u.push(n),
            f = 0;
          f < u.length;
          f++
          ...
          (v = u[f] == t),
            v
              ? r("#pages", e).append(
                  ' <span class="page active"><a style="cursor:pointer;" onclick="StampedFn.pageQuestions(this)" role="button" tabindex="0" data-product-id="" data-page="' +
                    u[f] +
                    '">' +
                    u[f] +
                    "</a></span> "
              ...
              : r("#pages", e).append(
                  ' <span class="page"><a style="cursor:pointer;" onclick="StampedFn.pageQuestions(this)" role="button" tabindex="0" data-product-id="" data-page="' +
                    u[f] +
                    '">' +
                    u[f] +
                    "</a></span> "
    ...
    function gt(n, t) {
      r("#stamped-questions-placeholder, .stamped-questions-placeholder")
        .length ||
        (r(".stamped-tabs #tab-reviews").removeClass("active"),
        r(".stamped-tabs #tab-questions").removeClass("active"),
        t == "questions"
          ? r(".stamped-tabs #tab-questions").addClass("active")
          : t == "reviews" &&
            r(".stamped-tabs #tab-reviews").addClass("active"),
    ...
    function ge() {
      ...
      if (
        ((oi = r(
          ".stamped-product-reviews-badge[data-id], .stamped-product-reviews-badge[data-product-id]"
        )),
        oi.length &&
          ((i = r.map(oi, function (n) {
            if (
              !r.trim(r(n).html()) &&
              (r(n).attr("data-id") ||
                r(n).attr("data-product-id") ||
                r(n).attr("data-type") ||
                r(n).attr("data-product-type") ||
                r(n).attr("data-product-sku") ||
                r(n).attr("data-product-title"))
            )
              return {
          ...
          i &&
            ...
            r.ajax({
              ...
              url:
                o.SECURE_ENDPOINT +
                "/widget/badges" +
                (o.is_disable_cache_badge === !0 ? "?isUseCache=false" : ""),
              data: JSON.stringify({
                productIds: i,
                apiKey: n.StampedGlobalOptions.apiKey,
                sId: n.StampedGlobalOptions.sId,
              ...
              success: function (n) {
                oi.each(function () {
                  ...
                  t >= 0 && (!i || i == "review")
                    ? r(this).html(n[t].badge)
                    : t >= 0 && i == "qna" && r(this).html(n[t].badgeqna);
                });
        ...
        r(
          ".stamped-product-reviews-badge[data-id].stamped-main-badge, .stamped-product-reviews-badge:first"
        ).length)
      )
        r(t).on(
          "click",
          ...
          function () {
            if (r(this).attr("data-type") === "qna") {
              if (
                (r("#stamped-questions-placeholder").length
                  ? b("#stamped-questions-placeholder")
                  : (gt(null, "questions"), b(v)),
                r(".stamped-badge-caption[data-questions]").length)
              ) {
                var n = r(".stamped-badge-caption[data-questions]").attr(
                  "data-questions"
                );
        ...
        if (((r = n[i]), t != !0 || r.reviewUserPhotos || r.reviewUserVideos)) {
          if (
            ...
            if (r.reviewUserVideos)
              for (
                e = r.reviewUserVideos.split(","), ii = 0;
                ii < e.length;
                ii++
              )
                (f =
                  "//s3.us-west-2.amazonaws.com/stamped.io/uploads/videos/" +
                  e[ii]),
            ...
            if (r.reviewUserPhotos)
              for (
                o = r.reviewUserPhotos.split(","),
                  h = "//cdn.stamped.io/uploads/photos/",
                  r.reviewUserPhotosWatermark &&
                    (h =
                      "//cdn.stamped.io/" +
                      r.reviewUserPhotosWatermark +
                      "/uploads/photos/"),
                ...
                u.photos.push({
                  imageUrl: h + o[ii],
                  imageThumbnailUrl:
                    "//cdn.stamped.io/uploads/photos/thumb/" + o[ii],
                });
          } else
            u.photos.push({
          ...
          if (r.reviewOptionsList && r.reviewOptionsList.length)
            for (ii = 0; ii < r.reviewOptionsList.length; ii++)
              u.options.push({
    ...
    function io(i, u, f, e, s, c, l, v, y) {
      ...
      var p,
        ...
        ot = r(f).attr("data-url-stockist") || br || "",
        yt = r(f).attr("data-cropped") == "false" ? !0 : !1,
        pt = r(f).attr("data-page") || 1,
        wt = r(f).attr("data-take") || 30;
      for (
        r("#stamped-ugc-modal").length ||
          ((p = r(ht)),
          p.attr("data-modal-type", e),
          p.attr("data-modal-shoppable", y || !1),
          r(p).appendTo(t.body),
          p.focus()),
          tt = "",
          st = i.length,
        ...
        (b = i[w]),
          (rt = b.imageUrl),
          rt && ((tt += templateBlock.formatStringStamped(it, rt)), it++),
          b.photos.length &&
            b.photos[0].imageUrl &&
            ((sr[w] = new Image()), (sr[w].src = b.photos[0].imageUrl));
      if ((r(".stamped-ugc-media-block-template", f).append(tt), !ft)) {
        ...
        p.on(
          "click keypress",
          ".stamped-ugc-modal-nav-previous, .stamped-ugc-modal-nav-next",
          function (n) {
            if (a(n) === !0) {
      ...
      var ct = function () {
          ...
          r(
            ".stamped-ugc-modal-image-wrapper ul li:nth-child(" + t + ")"
          ).addClass("active");
          o.modal_ugc_image_viewer == "image"
            ? r(".stamped-ugc-modal-image", p).html(
                '<img src="' + n + '" alt="Customer Photo" />'
              )
            : r(".stamped-ugc-modal-image", p).css(
                "background-image",
                "url(" + n + ")"
              );
        ...
        lt = function () {
          ...
          r(
            ".stamped-ugc-modal-list-photos ul li[data-index-review=" +
              n +
              "][data-index-photo=" +
              t +
              "]"
        ...
        ut = function (u, f) {
          ...
          if (e != null && e.photos != null) {
            if (
              (f !== null
                ? ((c = f), f > e.photos.length - 1 && (c = 0))
                : c
                ? c > e.photos.length - 1 && (c = 0)
                : (c = 0),
              !r(".stamped-ugc-modal-list-photos ul li", p).length)
            ) {
              for (b = 0; b < i.length; b++)
                for (k = 0; k < i[b].photos.length; k++) {
                  ...
                  n.LazyLoadStamped && LazyLoadStamped.update
                    ? ((vt = t.createAttribute("data-bg")),
                      (vt.value = "url(" + wt + ")"),
                      y.setAttributeNode(vt))
                    : (y.style.background = "url(" + wt + ")");
                  r(".stamped-ugc-modal-list-photos ul", p).append(y);
                  y.onclick = lt;
                }
              r(t).on(
                "click keypress",
                ".stamped-ugc-modal-list-photos li.stamped-lazyload",
                function (n) {
                  a(n) &&
                    (r(this).attr("aria-current", "true"),
                    r(this).siblings().attr("aria-current", "false"));
                }
              );
              try {
                n.LazyLoadStamped &&
            ...
            for (
              r(
                ".stamped-ugc-modal-list-photos li.stamped-lazyload.active"
              ).attr("aria-current", "true"),
                r(".stamped-ugc-modal-list-photos li.stamped-lazyload.active")
                  .siblings()
                  ...
                  ut
                    ...
                    : yt &&
                      r(".stamped-ugc-modal-image", p).fadeOut("", function () {
                        ...
                        r(".stamped-ugc-modal-image", p).html(
                          '<video class="stamped-ugc-modal-video" src="' +
                            yt +
            ...
            if (
              ...
              v &&
                l != "en" &&
                ((ft = v.label_verified_buyer || ft),
                (st = v.label_shop_now || st)),
              it.append(
                '<span class="stamped-verified-badge">' + ft + "</span>"
              ),
              r(".stamped-ugc-modal-tags-btn", p).append(
                "<span>" + st + "</span>"
              ),
              (ht = ""),
              e.rating)
            ) {
              for (tt = 0; tt < e.rating; tt++)
                ht +=
                  '<i class="stamped-fa stamped-fa-star" aria-hidden="true"></i>';
              for (tt = 0; tt < 5 - e.rating; tt++)
                ht +=
            ...
            for (
              ...
              (s = e.products[w]),
                ...
                ot
                  ? ((s.url = s.url.replace("?stockistUrl=https://", "")),
                    (s.url = s.url + "?stockistUrl=" + ot))
                  : et && (s.url = s.url + "?param=" + et),
                (gt = s.imageUrl || s.imageLargeUrl),
                s.imageUrl
                  ? r(".stamped-ugc-modal-tags", p).append(
                      nt.formatStringStamped(
                        'href="' + s.url + '" rel="nofollow"',
                        'src="' + gt + '"',
                        s.title,
                        s.productUrl
                      )
            ...
            p.hasClass("open") ||
              (p.addClass("open"),
              r("body").addClass("stamped-modal-open"),
              h("stamped:ugcmodal:open"));
          }
        },
        g = function (n) {
          var u, f, t, i;
          if (p.hasClass("open"))
            if (
              ((u = p.attr("data-review-index")),
              (f = p.attr("data-photo-index")),
              r('[data-direction="right"]', p).removeClass("nav-disabled"),
              r('[data-direction="left"]', p).removeClass("nav-disabled"),
              n == "left")
            )
              (t = r(".stamped-ugc-modal-list-photos ul li.active").prev()),
                t.click(),
                t.length ||
                  r('[data-direction="left"]', p).addClass("nav-disabled");
            else if (n == "right")
              (i = r(".stamped-ugc-modal-list-photos ul li.active").next()),
                r(i.click()),
                i.length ||
                  (r('[data-direction="right"]', p).addClass("nav-disabled"),
                  p.attr("data-modal-type") == "instagram" &&
                    h("stamped:ugcmodal:last"));
            else return;
        };
      i != null && i.length && ut(u, c);
    }
    function cr(t, i) {
      var u = r(t),
        ...
        h = u.attr("data-review-ids")
          ? u.attr("data-review-ids").toString().split(",")
          : null,
        c = u.attr("data-product-id"),
        l = u.attr("data-product-ids")
          ? u.attr("data-product-ids").toString().split(",")
          : null,
        ...
        success: function (t) {
          for (var u, e, o = t.length, f = 100, i = 0; i < o; i++)
            t[i] &&
              ...
              (e =
                n == "rewards"
                  ? r('#stamped-rewards-widget[data-element-id="' + u + '"]')
                  : r('#stamped-reviews-widget[data-element-id="' + u + '"]')),
              ar(e, t[i], t.translations, f));
        },
      });
    }
        ...
        if (u) {
          ...
          f == "single"
            ? (i.append(e),
              ...
              StampedWidgetSingleFn.init(u.data, i, r))
            ...
            ? (i.append(e),
              ...
              StampedWidgetFullPageMultipleFn.init(u, i, r))
            : f == "reviews-highlight"
            ? (i.append(e),
              StampedWidgetReviewsHighlightFn,
              StampedWidgetReviewsHighlightFn.init(u, i, r))
            : f == "reviews-popup"
            ? (i.append(e),
              StampedWidgetReviewsPopupFn,
              StampedWidgetReviewsPopupFn.init(u, i, r))
            : f == "people-highlight"
            ? (i.append(e),
              StampedWidgetPeopleHighlightFn,
              StampedWidgetPeopleHighlightFn.init(u, i, r))
            : f == "drawer"
            ? (i.append(e),
              StampedWidgetDrawerFn,
              StampedWidgetDrawerFn.init(u, i, r))
            : f == "carousel"
            ? (i.append(e), StampedCarouselFn, StampedCarouselFn.init(u, i, r))
            : f == "carousel-nps"
            ? (i.append(e),
              StampedCarouselNPSFn,
              StampedCarouselNPSFn.init(u, i, r))
            : f == "carousel-checkout-comments"
            ? (i.append(e),
              StampedCarouselCheckoutCommentFn,
              StampedCarouselCheckoutCommentFn.init(u, i, r))
            : f == "carousel-photos"
            ? (i.append(e),
              StampedCarouselPhotosFn,
              StampedCarouselPhotosFn.init(u.data, i, r))
            : f == "site-badge"
            ? (i.append(e),
              StampedSiteBadgeFn,
              StampedSiteBadgeFn.init(u, i, r))
            : f == "top-rated"
            ? (i.append(e), StampedTopRatedFn, StampedTopRatedFn.init(u, i, r))
            : f == "wall-photos"
            ? (i.append(e),
              StampedWallPhotosFn,
              StampedWallPhotosFn.init(u, i, r),
              o && b(i))
            : f == "checkout-comments"
            ? (i.append(e),
              StampedCheckoutCommentsFn,
              StampedCheckoutCommentsFn.init(u, i, r))
            : f == "instagram-feed"
            ? (r(i).is(":empty") && i.append(e),
              StampedInstagramFeedFn,
              StampedInstagramFeedFn.init(u, i, r))
            : f == "visual-gallery"
            ? (n.stampedVisualGalleryDataArr || i.append(e),
              StampedVisualGalleryFeedFn,
              StampedVisualGalleryFeedFn.init(u, i, r))
            : f == "facebook-messenger-optin"
            ? (StampedFacebookMessengerOptinFn,
              StampedFacebookMessengerOptinFn.init(u, i, r))
            : f == "nps-submission-form"
            ? (i.append(e),
              StampedNPSSubmissionForm,
              StampedNPSSubmissionForm.init(u, i, r))
            : f == "rewards-summary"
            ? (i.append(e),
              StampedRewardsSummary,
              StampedRewardsSummary.init(u, i, r))
            : f == "rewards-how-it-works"
            ? (i.append(e),
              StampedRewardsHowItWorks,
              StampedRewardsHowItWorks.init(u, i, r))
            : f == "rewards-referral-modal"
            ? (i.append(e),
              StampedRewardsReferralModal,
              StampedRewardsReferralModal.init(u, i, r))
            : f == "rewards-referral-claim-modal"
            ? (i.append(e),
              StampedRewardsReferralClaimModal,
              StampedRewardsReferralClaimModal.init(u, i, r))
            : f == "rewards-earnings" || f == "rewards-earnings-v2"
            ? (i.append(e),
              StampedRewardsEarnings,
              StampedRewardsEarnings.init(u, i, r))
            : f == "rewards-spendings" || f == "rewards-spendings-v2"
            ? (i.append(e),
              StampedRewardsSpendings,
              StampedRewardsSpendings.init(u, i, r))
            : f == "rewards-vip-tiers"
            ? (i.append(e),
              StampedRewardsVIPTiers,
              StampedRewardsVIPTiers.init(u, i, r))
            : f == "rewards-referral"
            ? (i.append(e),
              StampedRewardsReferral,
              StampedRewardsReferral.init(u, i, r))
            : f == "rewards-activities"
            ? (i.append(e),
              StampedRewardsActivities,
              StampedRewardsActivities.init(u, i, r))
            : f == "rewards-redeem-variable-slider"
            ? (i.append(e),
              StampedRewardsRedeemVariableSlider,
              StampedRewardsRedeemVariableSlider.init(u, i, r))
            : f == "rewards-redeem-select-options" &&
              (i.append(e),
              StampedRewardsRedeemSelectOptions,
              StampedRewardsRedeemSelectOptions.init(u, i, r));
          fo();
    ...
    function fo() {
      ...
      n.lenght < 1 &&
        r(".free-tier-banner").detach().appendTo("#stamped-reviews-widget");
    }
    function ai(n, i, r) {
      var u, f;
      r
    ...
    function vr(n) {
      for (
        var i, u = n + "=", f = t.cookie.split(";"), r = 0;
        r < f.length;
        r++
      ) {
    ...
    function ni(n) {
      for (var t in n)
        (n[t] === null || n[t] === "" || typeof n[t] == "undefined") &&
          delete n[t];
      return n;
    }
    function eo(n) {
      var t = {},
        i;
      return (
        r(n).hasClass("new-review-form") ||
          (n = r(n).parents(".new-review-form")),
        (i = r("input,textarea,select,radio", n).serializeArray()),
        r.each(i, function () {
          t[this.name] !== undefined
    ...
    function b(n) {
      ...
      if (
        ...
        ki() &&
          (u =
            r(v).attr("data-offset-mobile") ||
            r(n).attr("data-offset-mobile") ||
            1);
        i.on(
    ...
    function ri(n) {
      ...
      n == "review"
        ? (gt(null, "reviews"),
          ...
          r(t).find("input[type=text]").length > 0 &&
            r(t).find("input[type=text]").get(0).focus())
        : n == "question" &&
          (gt(null, "questions"),
    ...
    function lo(t) {
      ...
      if (((i = eo(t)), i.reviewRating) && i.author && i.reviewMessage.trim()) {
        ...
        for (c in i)
          (v = i[c]),
            v.indexOf("+") > -1 &&
              c.indexOf("customFormOption") > -1 &&
              (v = i[c].replace("+", "%2B")),
            f.append(c, v);
        e = 0;
        for (b in ft)
          f.append("image" + e, ft[e]), (i["image" + e] = ft[e]), e++;
        ...
        w = {
          ...
          error: function (n) {
            ...
            o.is_ignore_submit_error == !0
              ? rf(y, n, a, l)
              : (r("#stamped-button-submit", u).removeAttr("disabled"),
                l && r("#stamped-button-submit", u).val(l));
          },
          success: function (n) {
            rf(y, n, a, l);
          },
    ...
    function ao(t) {
      ...
      if (u.length && f.length) {
        ...
        i.push({
          name: "stockistUrl",
          value: n.StampedGlobalOptions.stockistUrl,
        });
    ...
    function ot(n, t, i) {
      ...
      f = r(
        ".stamped-summary-ratings.selected .summary-rating-bar.selected",
        u
      ).attr("data-rating");
      f && (t = f);
      r(".stamped-sort-select", u).length &&
        (e = r(".stamped-sort-select", u).val());
      dt(n, e, t);
    }
    function vo(n) {
    ...
    function po(n) {
      ...
      i &&
        f &&
        nr(
          { customOptionTitle: i, customOptionValue: f },
          u.attr("data-product-id")
        );
    }
    function uf(n) {
      if (n == "qna")
        r(".stamped-questions-filter .stamped-summary-actions-clear").hide(),
          r(".stamped-questions-search-input").val(""),
          r(".stamped-questions-search-clear").hide(),
          r(u).removeAttr("data-search-qna"),
          ui();
    ...
    function go(t, i, f, e) {
      ...
      if (vi) {
        ...
        h != null &&
          (f, StampedFn.openUGCModal(it, h, r(v), null, null, f, yr));
        vi = !1;
      } else {
        vi = !0;
        var y = o.SECURE_ENDPOINT + "/widget/reviews",
          ...
          a = [];
        e === !0
          ? ((i = r(u).attr("data-product-id") || ""),
            (c = r(u).attr("data-name") || ""),
            (l = r(u).attr("data-product-type") || ""))
        ...
        r.ajax({
          ...
          success: function (n) {
            var e, u;
            for (it = n.data, e = null, u = 0; u < it.length; u++)
              it[u].id == t && (e = u);
            e != null &&
              (f,
              (yr = n.lang),
              StampedFn.openUGCModal(
                it,
                e,
                r(v),
                null,
            ...
            (i !== null &&
              ...
              r.ajax({
                ...
                success: function (n) {
                  ...
                  u = r("#stamped-facebook-optin .fb-send-to-messenger")[0]
                    .outerHTML;
    ...
    function s(t, i) {
      ...
      u &&
        (i || console.log("[Stamped.io]", t),
        i && r && console.log("[Stamped.io level" + r + "]", t));
    }
    function yi(n, i) {
    ...
    function ff(n, t) {
      try {
        return typeof Storage != "undefined"
          ? (localStorage.setItem(n, JSON.stringify(t)), !0)
          : !1;
      } catch (i) {}
    }
    function ef(n) {
    ...
    function of(n, t) {
      ...
      r && r.apiKey
        ...
        : ((i = new XMLHttpRequest()),
          (i.onreadystatechange = function () {
            ...
            i.readyState === 4 &&
              ...
              n &&
                n.apiKey &&
                (ff(f, n),
                h("stamped:init:getAppKey", { detail: n }),
                n.skip === !0 ||
                  ((appKey = n.apiKey),
                  (t = { apiKey: appKey }),
                  typeof hatch != "undefined"
                    ? (t.stockistUrl = hatch.shop)
                    : (t.sId = n.sId),
                  fi(t))));
          }),
          (u = ""),
          n == "hatch"
            ? (u = "shophatchDomain=" + t)
            : n == "bigcommerce" && (u = "stockistHash=" + t),
    ...
    function fi(t) {
      ...
      if (
        ...
        t && ((br = t.stockistUrl), (n.StampedGlobalOptions = t)),
        n.StampedGlobalOptions && n.StampedGlobalOptions.apiKey)
      ) {
    ...
    function h(i, r) {
      var u;
      n.CustomEvent
        ? (u = new CustomEvent(i, r))
        : ((u = t.createEvent("CustomEvent")), u.initCustomEvent(i, !0, !0, r));
      try {
        t.dispatchEvent(u);
      } catch (f) {}
    }
    ...
    function ss() {
      ...
      n.forEach(function (n) {
        n.classList.contains("active")
          ? n.children[0].setAttribute("aria-current", "page")
    ...
    var o = {
        ...
        rewards_apply_discount_url_format:
          n.stamped_rewards_apply_discount_url_format || "",
    ...
    if ((at && (at = at.split("#")[0]), at)) {
      ...
      n.get("test") === "loyalty2023" &&
        (console.log("test loyalty 2023 preview"), (p = !0));
      n.has("testLoyaltyAccount") &&
        (console.log("test loyalty 2023 account"),
        (d = n.get("testLoyaltyAccount")));
    }
    var ut,
      r,
      wi = !1,
      ...
      var f = "undefined" != typeof n,
        ...
        k = function (n, t) {
          ...
          0 === n._elements.length &&
            0 === n._loadingCount &&
            r(n._settings.callback_finish);
        },
        d = function (n) {
          for (var t, i = [], r = 0; (t = n.children[r]); r += 1)
        ...
        (c.prototype = {
          update: function (n) {
            ...
            ((this._elements = ut(n, t)), !l && this._observer)
              ? ((function (n) {
                  return (
                    n.use_native && "loading" in HTMLImageElement.prototype
                  );
                })(t) &&
                  ((i = this)._elements.forEach(function (n) {
                    -1 !== vt.indexOf(n.tagName) &&
                      (n.setAttribute("loading", "lazy"), h(n, i));
                  }),
    ...
    !(function (n, t) {
      ...
      function s(n, i, f) {
        i = r[i] ? i : r[f] ? f : "en";
        for (
          var e = 0, o = n < 0 ? 1 : 0, s = (n = Math.abs(n));
          n >= t[e] && e < l;
          e++
        )
          n /= t[e];
      ...
      function a(n) {
        for (var u = 1, i = 0, r = Math.abs(n); n >= t[i] && i < l; i++)
          (n /= t[i]), (u *= t[i]);
    ...
    if (
      ...
      typeof hatch != "undefined" &&
        ...
        hatch.shop &&
          (w != null &&
            (lt.indexOf("skip=true") > -1 && (pi = !0),
            (ei = w.getAttribute("data-api-key")),
            !ei && lt.indexOf("apiKey") > -1 && (ei = k("apiKey", lt)),
            ei && ((pi = !0), fi({ apiKey: ei, stockistUrl: hatch.shop }))),
          pi || of("hatch", hatch.shop)),
        hatch.Checkout && typeof StampedhatchCheckout == "undefined"))
    ) {
      if (typeof n.StampedhatchCheckout == "function") return !1;
      yi("//cdn1.stamped.io/files/hatch-checkout.min.js", function () {
        h("stamped:script-hatch-checkout:loaded");
      });
    }
    if (w != null) {
      wr = w.getAttribute("data-stockist-hash");
      wr && of("bigcommerce", wr);
      var sf = w.getAttribute("data-stockist-id"),
