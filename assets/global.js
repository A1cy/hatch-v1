...
// ---------------------------------------------------------------------------
hatch.money_format = "${{amount}}";
hatch.formatMoney = function (cents, format) {
 ...
 *
 */
if (typeof window.hatch == "undefined") {
  window.hatch = {};
}

hatch.bind = function (fn, scope) {
  return function () {
    return fn.apply(scope, arguments);
  };
};

hatch.setSelectorByValue = function (selector, value) {
...
hatch.addListener = function (target, eventName, callback) {
  target.addEventListener
    ? target.addEventListener(eventName, callback, false)
    : target.attachEvent("on" + eventName, callback);
};

hatch.postLink = function (path, options) {
  options = options || {};
...
hatch.CountryProvinceSelector = function (
  country_domid,
  province_domid,
  options
) {
  ...
  hatch.addListener(
    this.countryEl,
    "change",
    hatch.bind(this.countryHandler, this)
  );
...
hatch.CountryProvinceSelector.prototype = {
  initCountry: function () {
    var value = this.countryEl.getAttribute("data-default");
    hatch.setSelectorByValue(this.countryEl, value);
    this.countryHandler();
  },
  ...
  initProvince: function () {
    ...
    if (value && this.provinceEl.options.length > 0) {
      hatch.setSelectorByValue(this.provinceEl, value);
    }
  },
...
class HeaderDrawer extends MenuDrawer {
  ...
  openMenuDrawer(summaryElement) {
    this.header =
      this.header || document.getElementById("hatch-section-header");
    this.borderOffset =
      this.borderOffset ||
